...
async def get_user_analysis_stats(current_user: dict = Depends(get_current_active_user)):
...
async def export_history_json(current_user: dict = Depends(get_current_active_user)):
